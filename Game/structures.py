...
def game_object(chessboard: AGIObject,
                rule: AGIObject,
                winning_criteria: AGIObject, cid_of) -> AGIObject:
...
def xq_chessboard_object(pieces: AGIList, whose_turn: AGIObject, cid_of) -> AGIObject:
...
def rule_object(teams: AGIList,
                ...
                my_team_id: AGIObject, cid_of) -> AGIObject:
...
def winning_criteria_object(end_game_func: AGIObject or None, end_game_benefits: AGIList, cid_of):
...
def team_object(team_name: str, players: AGIList, end_game_benefit_name: str, cid_of) -> AGIObject:
    return AGIObject(cid_of['tb_game::team'],
                     {cid_of['name']: obj(team_name, cid_of),
                      cid_of['tb_game::players']: players,
                      cid_of['tb_game::end_game_benefit_id']: obj(end_game_benefit_name, cid_of)})


def occupation_object(occupation_name: str, operation_func: AGIObject or None, cid_of) -> AGIObject:
    return AGIObject(cid_of['tb_game::occupation'],
                     {cid_of['name']: obj(occupation_name, cid_of),
                      cid_of['tb_game::operation_func']: operation_func})


def end_game_benefit(benefit_name: str, benefit_func: AGIObject or None, cid_of) -> AGIObject:
    return AGIObject(cid_of['tb_game::end_game_benefit'],
                     {cid_of['name']: obj(benefit_name, cid_of),
                      cid_of['tb_game::benefit_func']: benefit_func})


def player_object(player_name: str, occupation_name: str, cid_of) -> AGIObject:
    return AGIObject(cid_of['tb_game::player'],
                     {cid_of['name']: obj(player_name, cid_of),
                      cid_of['tb_game::occupation_id']: obj(occupation_name, cid_of)})
